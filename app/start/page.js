...
export default function Page() {
  return (
    <div className="bg-[#fefcf9] min-h-screen text-slate-700 font-sans">
      <header className="fixed top-0 left-0 w-full bg-[#fefcf9] z-50 flex justify-between px-6 py-4 border-b border-gray-200 shadow-sm">
      ...
      <main className="pt-20 flex flex-col items-center">
          ...
          <div className="mt-6 w-[300px] bg-green-50 text-left text-sm p-4 rounded-md mx-auto">
            ...
            <ul className="space-y-1">
              <li className="flex items-center">
                <FaCheckCircle className="text-green-600 mr-2" /> Custom mortgage rates
              </li>
              <li className="flex items-center">
                <FaTags className="text-green-600 mr-2" /> Exclusive offers
              </li>
              <li className="flex items-center">
                <FaUserCircle className="text-green-600 mr-2" /> A personalized dashboard
              </li>
            </ul>
          </div>
        </section>
        ...
        <footer className="w-full mt-20 text-sm text-slate-600 border-t border-gray-300 px-10 py-6">
          ...
          <div className="text-xs mt-8">
            © 2025 Better Mortgage Corporation and/or its affiliates. Better is a family of companies.
            Mortgage loans offered by Better Mortgage Corporation. Loans made or arranged pursuant to
            California Finance Lenders Law License. Equal Housing Lender. NMLS Consumer Access.
          </div>
        </footer>
